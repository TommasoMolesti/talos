...
Talos publishes repeatable GitHub releases from version tags. A tag like `v0.2.0` triggers the release workflow, builds Linux, macOS, and Windows binaries, generates `checksums.txt`, and attaches all assets to the GitHub Release.
